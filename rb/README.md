# EvaEmailVerification Ruby SDK



The Ruby SDK for the EvaEmailVerification API — an entity-oriented client using idiomatic Ruby conventions.
...
raise a `EvaEmailVerificationError` (a `StandardError` subclass), so wrap
...
```
rb/
├── EvaEmailVerification_sdk.rb       -- Main SDK module
