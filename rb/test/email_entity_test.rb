...
class EmailEntityTest < Minitest::Test
  ...
  def test_basic_flow
    ...
    if setup[:synthetic_only]
      skip "live entity test uses synthetic IDs from fixture — set EVAEMAILVERIFICATION_TEST_EMAIL_ENTID JSON to run live"
      return
    end
    client = setup[:client]
...
def email_basic_setup(extra)
  ...
  entid_env_raw = ENV["EVAEMAILVERIFICATION_TEST_EMAIL_ENTID"]
