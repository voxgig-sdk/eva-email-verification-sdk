...
#      offline in seeded test mode (EvaEmailVerificationSDK.test) against the real
...
class ReadmeExamplesTest < Minitest::Test
  ...
  SDK = File.join(__dir__, "..", "EvaEmailVerification_sdk.rb")
  SDK_CLASS = "EvaEmailVerificationSDK"
  ...
  SDK_BASE = "EvaEmailVerification_sdk"
