// Command EvaEmailVerification-cli is a CLI + REPL for the EvaEmailVerification SDK,
...
const prompt = "eva-email-verification"

// entitiesHelp is the space-separated entity list shown by /help.
const entitiesHelp = "email"
...
func usage(out io.Writer) {
	...
	fmt.Fprintln(out, "Env:      EVA_EMAIL_VERIFICATION_APIKEY (api key), EVA_EMAIL_VERIFICATION_BASE (base url override)")
