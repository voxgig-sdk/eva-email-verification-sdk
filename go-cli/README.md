...
AQL-driven CLI and REPL for the EvaEmailVerification SDK. Positional arguments are
...
```sh
go build -o eva-email-verification-cli ./...
```
...
./eva-email-verification-cli list email
./eva-email-verification-cli load 1 email
./eva-email-verification-cli load '{id:1}' email
