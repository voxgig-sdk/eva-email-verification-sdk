...
func registerSDKWords(r *eng.Registry, client *sdk.EvaEmailVerificationSDK) {
...
func runOp(client *sdk.EvaEmailVerificationSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
