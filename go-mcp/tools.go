...
type Args struct {
	Entity string         `json:"entity" jsonschema:"email"`
	Query  map[string]any `json:"query,omitempty" jsonschema:"optional match map e.g. {\"id\":1} for load, omit for list"`
}

func registerTools(server *mcp.Server, client *sdk.EvaEmailVerificationSDK) {
	mcp.AddTool(server, &mcp.Tool{
		Name: "eva-email-verification_list",
		Description: "List records from EvaEmailVerification. " +
	...
	mcp.AddTool(server, &mcp.Tool{
		Name: "eva-email-verification_load",
		Description: "Load a single record from EvaEmailVerification. " +
...
func runOp(client *sdk.EvaEmailVerificationSDK, op string, args Args) (*mcp.CallToolResult, any, error) {
...
func entityFor(client *sdk.EvaEmailVerificationSDK, name string) (sdk.EvaEmailVerificationEntity, error) {
