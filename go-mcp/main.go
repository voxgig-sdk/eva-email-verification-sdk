// Command EvaEmailVerification-mcp is an MCP server exposing the EvaEmailVerification
// SDK as MCP tools.
//
// Two tools are registered:
//
//	EvaEmailVerification_list  — list records of an entity
//	EvaEmailVerification_load  — load a single record of an entity
//
