...
API for email verification. Validate and verify email addresses programmatically.
...
Results: Successful email verification response.
...
| --- | --- | --- | --- |
| Email | `load` | `GET /email` | See reference |

## Connect to the API

- Production server: `https://api.eva.pingutil.com`
...
- `eva-email-verification_list`: List records for an entity. No active entity supports this operation.
- `eva-email-verification_load`: Load one record for an entity. Supported entities: `email`.
