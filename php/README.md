# EvaEmailVerification PHP SDK



The PHP SDK for the EvaEmailVerification API — an entity-oriented client using PHP conventions.
...
```
php/
├── evaemailverification_sdk.php          -- Main SDK class
...
The main class (`evaemailverification_sdk.php`) exports the SDK class
