...
The PHP SDK for the EvaEmailVerification API. Provides an entity-oriented interface using PHP conventions.
...
[$result, $err] = $client->EvaEmailVerification(null)->load(
    ["id" => "test01"], null
);
