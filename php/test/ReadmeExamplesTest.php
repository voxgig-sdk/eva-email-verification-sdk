...
// EvaEmailVerification SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (EvaEmailVerificationSDK::test)
...
{
    private const SDK_CLASS = 'EvaEmailVerificationSDK';
    ...
    private const SDK_BASE = 'evaemailverification_sdk';
    ...
    public function test_php_examples_run_offline(): void
    {
        $ran = 0;
        $failures = [];
        $sdk = __DIR__ . '/../evaemailverification_sdk.php';
        foreach ($this->phpBlocks() as $blk) {
