...
// EvaEmailVerification SDK ratelimit feature
...
class EvaEmailVerificationRatelimitFeature extends EvaEmailVerificationBaseFeature
{
    ...
    private function _acquire(EvaEmailVerificationContext $ctx): void
    {
    ...
    private function _track(EvaEmailVerificationContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
