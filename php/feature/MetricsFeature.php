...
// EvaEmailVerification SDK metrics feature
...
class EvaEmailVerificationMetricsFeature extends EvaEmailVerificationBaseFeature
{
    ...
    private function _record(EvaEmailVerificationContext $ctx, bool $ok): void
    {
