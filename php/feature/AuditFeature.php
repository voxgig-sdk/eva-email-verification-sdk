...
// EvaEmailVerification SDK audit feature
...
class EvaEmailVerificationAuditFeature extends EvaEmailVerificationBaseFeature
{
    ...
    private function _emit(EvaEmailVerificationContext $ctx, string $outcome): void
    {
