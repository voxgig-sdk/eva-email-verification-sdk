...
// EvaEmailVerification SDK telemetry feature
...
class EvaEmailVerificationTelemetryFeature extends EvaEmailVerificationBaseFeature
{
    ...
    private function _close(EvaEmailVerificationContext $ctx, bool $ok): void
    {
