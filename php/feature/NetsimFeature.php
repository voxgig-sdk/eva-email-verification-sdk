...
// EvaEmailVerification SDK netsim feature
...
class EvaEmailVerificationNetsimFeature extends EvaEmailVerificationBaseFeature
{
    ...
    private function _simulate(EvaEmailVerificationContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
        $this->calls++;
        $call = $this->calls;
    ...
    private function _track(EvaEmailVerificationContext $ctx, array $applied): void
    {
        $client = $this->client;
