...
// EvaEmailVerification SDK debug feature
...
class EvaEmailVerificationDebugFeature extends EvaEmailVerificationBaseFeature
{
    ...
    private function _finish(EvaEmailVerificationContext $ctx, bool $ok): void
    {
