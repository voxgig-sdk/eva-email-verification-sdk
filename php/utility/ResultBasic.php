...
// EvaEmailVerification SDK utility: result_basic

class EvaEmailVerificationResultBasic
{
    public static function call(EvaEmailVerificationContext $ctx): ?EvaEmailVerificationResult
    {
        ...
        if ($result && $response) {
            ...
            if ($result->status >= 400) {
                ...
                if ($result->err) {
                    $prev = ($result->err instanceof EvaEmailVerificationError) ? $result->err->msg : (string)$result->err;
