...
// EvaEmailVerification SDK utility: make_request

require_once __DIR__ . '/../core/Response.php';
require_once __DIR__ . '/../core/Result.php';

class EvaEmailVerificationMakeRequest
{
    public static function call(EvaEmailVerificationContext $ctx): array
    {
        ...
        if ($fetch_err) {
            ...
            $response = new EvaEmailVerificationResponse(['err' => $ctx->make_error('request_no_response', 'response: undefined')]);
        } elseif (is_array($fetched)) {
            $response = new EvaEmailVerificationResponse($fetched);
        } else {
