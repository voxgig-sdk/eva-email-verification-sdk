...
// EvaEmailVerification SDK utility: fetcher

class EvaEmailVerificationFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; EvaEmailVerificationSDK/1.0)';
    ...
    public static function call(EvaEmailVerificationContext $ctx, string $fullurl, array $fetchdef): array
    {
