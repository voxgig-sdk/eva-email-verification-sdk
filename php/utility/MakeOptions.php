...
// EvaEmailVerification SDK utility: make_options

class EvaEmailVerificationMakeOptions
{
    ...
    public static function call(EvaEmailVerificationContext $ctx): array
    {
        ...
        //
        // `EvaEmailVerificationSchema::optspec()` is built from the model:
        ...
        $optspec = EvaEmailVerificationSchema::optspec();
