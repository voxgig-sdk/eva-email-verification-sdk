...
function runner.env_override(m)
  local live = runner.getenv("EVA_EMAIL_VERIFICATION_TEST_LIVE")
  local override = runner.getenv("EVA_EMAIL_VERIFICATION_TEST_OVERRIDE")
  ...
  local explain = runner.getenv("EVA_EMAIL_VERIFICATION_TEST_EXPLAIN")
