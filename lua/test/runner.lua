...
function runner.env_override(m)
  local live = runner.getenv("EVAEMAILVERIFICATION_TEST_LIVE")
  local override = runner.getenv("EVAEMAILVERIFICATION_TEST_OVERRIDE")
  ...
  local explain = runner.getenv("EVAEMAILVERIFICATION_TEST_EXPLAIN")
