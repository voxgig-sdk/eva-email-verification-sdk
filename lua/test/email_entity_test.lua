...
describe("EmailEntity", function()
  ...
  it("should run basic flow", function()
    ...
    if setup.synthetic_only then
      pending("live entity test uses synthetic IDs from fixture — set EVA_EMAIL_VERIFICATION_TEST_EMAIL_ENTID JSON to run live")
      return
    end
...
function email_basic_setup(extra)
  ...
  local entid_env_raw = os.getenv("EVA_EMAIL_VERIFICATION_TEST_EMAIL_ENTID")
  ...
  if env["EVA_EMAIL_VERIFICATION_TEST_LIVE"] == "TRUE" then
