...
function envOverride(m: Record<string, any>) {
  if (
    'TRUE' === process.env.EVAEMAILVERIFICATION_TEST_LIVE ||
    'TRUE' === process.env.EVAEMAILVERIFICATION_TEST_OVERRIDE
  ) {
  ...
  m.EVAEMAILVERIFICATION_TEST_EXPLAIN = process.env.EVAEMAILVERIFICATION_TEST_EXPLAIN || m.EVAEMAILVERIFICATION_TEST_EXPLAIN
