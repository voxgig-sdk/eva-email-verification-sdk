# EvaEmailVerification TypeScript SDK

The TypeScript SDK for the EvaEmailVerification API. Provides a type-safe, entity-oriented interface with full async/await support.
...
| `tester(testopts?, sdkopts?)` | `EvaEmailVerificationSDK` | Create a test-mode client instance. |

#### Static methods

| Method | Returns | Description |
| --- | --- | --- |
| `EvaEmailVerificationSDK.test(testopts?, sdkopts?)` | `EvaEmailVerificationSDK` | Create a test-mode client. |
...
| `client` | `client(): EvaEmailVerificationSDK` | Return the parent SDK client. |
...
├── src/
│   ├── EvaEmailVerificationSDK.ts        # Main SDK class
