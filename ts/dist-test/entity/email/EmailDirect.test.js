...
(0, node_test_1.describe)('EmailDirect', async () => {
    ...
    (0, node_test_1.test)('direct-exists', async () => {
        const sdk = new __1.EvaEmailVerificationSDK({
...
function liveScenariosActive() { return false && process.env.EVA_EMAIL_VERIFICATION_TEST_LIVE === 'TRUE'; }
function directSetup(mockres) {
    ...
    if (live) {
        ...
        const client = new __1.EvaEmailVerificationSDK(Object.assign({}, (0, utility_1.liveClientOptions)(), { system: { fetch: transport.fetch },
        }));
        let idmap = env['EVA_EMAIL_VERIFICATION_TEST_EMAIL_ENTID'];
    ...
    const client = new __1.EvaEmailVerificationSDK({
        base: 'http://localhost:8080',
