...
function envOverride(m) {
    if ('TRUE' === process.env.EVA_EMAIL_VERIFICATION_TEST_LIVE ||
        'TRUE' === process.env.EVA_EMAIL_VERIFICATION_TEST_OVERRIDE) {
    ...
    m.EVA_EMAIL_VERIFICATION_TEST_EXPLAIN = process.env.EVA_EMAIL_VERIFICATION_TEST_EXPLAIN || m.EVA_EMAIL_VERIFICATION_TEST_EXPLAIN;
    return m;
}
