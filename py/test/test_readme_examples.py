# EvaEmailVerification SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions EvaEmailVerificationSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both EvaEmailVerificationSDK(...) and EvaEmailVerificationSDK.test(...) become
#      EvaEmailVerificationSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "evaemailverification_sdk"
_SDK_CLASS = "EvaEmailVerificationSDK"
