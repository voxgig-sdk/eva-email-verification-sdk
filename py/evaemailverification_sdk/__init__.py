...
from evaemailverification_sdk.utility import register

# Load features
from evaemailverification_sdk.feature.base_feature import EvaEmailVerificationBaseFeature
from evaemailverification_sdk.features import _has_feature, _make_feature
...
class EvaEmailVerificationSDK:
    ...
    def __init__(self, options=None):
        ...
        utility = EvaEmailVerificationUtility()
        self._utility = utility

        from evaemailverification_sdk.config import shared_config
    ...
    def get_utility(self):
        return EvaEmailVerificationUtility.copy(self._utility)
    ...
    def graphql(self, query, variables=None, ctrl=None):
        ...
        if isinstance(errors, list) and 0 < len(errors):
            ...
            res["ok"] = False
            res["err"] = Exception("EvaEmailVerificationSDK: graphql: " + str(msg))
            res["graphql"] = errors
    ...
    def Email(self, data=None) -> "EmailEntity":
        ...
        from evaemailverification_sdk.entity.email_entity import EmailEntity
