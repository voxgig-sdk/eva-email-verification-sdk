# EvaEmailVerification Python SDK



The Python SDK for the EvaEmailVerification API — an entity-oriented client following Pythonic conventions.
...
release tag (`py/vX.Y.Z`, see [Releases](https://github.com/voxgig-sdk/eva-email-verification-sdk/releases)) or
...
```python
client = EvaEmailVerificationSDK.test(testopts, sdkopts)
```
...
```
py/
├── evaemailverification_sdk.py         -- Main SDK module
...
The main module (`evaemailverification_sdk`) exports the SDK class.
