# EvaEmailVerification Golang SDK



The Golang SDK for the EvaEmailVerification API — an entity-oriented client using standard Go conventions. No generics required; data flows as `map[string]any`.
...
## Install
```bash
go get github.com/voxgig-sdk/eva-email-verification-sdk/go@latest
```

The Go module proxy resolves the version from the `go/vX.Y.Z` GitHub
release tag — see [Releases](https://github.com/voxgig-sdk/eva-email-verification-sdk/releases) for the available versions.
...
```bash
go mod edit -replace github.com/voxgig-sdk/eva-email-verification-sdk/go=../eva-email-verification-sdk/go
```
...
### NewEvaEmailVerificationSDK

```go
func NewEvaEmailVerificationSDK(options map[string]any) *EvaEmailVerificationSDK
```
...
```go
func TestSDK(testopts map[string]any, sdkopts map[string]any) *EvaEmailVerificationSDK
```

Creates a test-mode client with mock transport. Both arguments may be `nil`.

### EvaEmailVerificationSDK methods
...
| `Email` | `(data map[string]any) EvaEmailVerificationEntity` | Create an Email entity instance. |

### Entity interface (EvaEmailVerificationEntity)

All entities implement the `EvaEmailVerificationEntity` interface.
...
| --- | --- | --- |
| `disposable` | `bool` | Whether the email is from a disposable email provider |
| `domain` | `string` | The domain part of the email address |
| `email` | `string` | The email address that was verified |
| `free_provider` | `bool` | Whether the email is from a free email provider |
| `mx_records` | `bool` | Whether MX records exist for the domain |
| `role_account` | `bool` | Whether the email appears to be a role-based account |
| `smtp_check` | `bool` | Whether SMTP check was successful |
...
```
github.com/voxgig-sdk/eva-email-verification-sdk/go/
├── eva-email-verification.go        # Root package — type aliases and constructors
...
The root package (`github.com/voxgig-sdk/eva-email-verification-sdk/go`) re-exports everything needed
