...
from projectname_sdk.core.control import EvaEmailVerificationControl
...
class EvaEmailVerificationContext:
    def __init__(self, ctxmap=None, basectx=None):
        ...
        # Ctrl
        self.ctrl = EvaEmailVerificationControl()
        ...
        if isinstance(sp, EvaEmailVerificationSpec):
            self.spec = sp
        elif basectx is not None:
        ...
        if isinstance(r, EvaEmailVerificationResult):
            self.result = r
        elif basectx is not None:
        ...
        if isinstance(rp, EvaEmailVerificationResponse):
            self.response = rp
        elif basectx is not None:
    ...
    def resolve_op(self, opname):
        ...
        if opname == "":
            return EvaEmailVerificationOperation({})
    ...
    def make_error(self, code, msg):
        return EvaEmailVerificationError(code, msg, self)
