...
class EvaEmailVerificationTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = EvaEmailVerificationTestRunner.getenv("PROJECTENV_TEST_LIVE")
        override = EvaEmailVerificationTestRunner.getenv("PROJECTENV_TEST_OVERRIDE")
        ...
        explain = EvaEmailVerificationTestRunner.getenv("PROJECTENV_TEST_EXPLAIN")
