# EvaEmailVerification SDK feature corpus test
#
...
def _client(kase):
    ...
    EvaEmailVerificationSDK(...), not EvaEmailVerificationSDK.test(...): the `test` feature is
    ...
    return EvaEmailVerificationSDK(opts)
