...
// EvaEmailVerification SDK utility type

class EvaEmailVerificationUtility
{
    ...
    public static function copy(EvaEmailVerificationUtility $src): EvaEmailVerificationUtility
    {
        $u = new EvaEmailVerificationUtility();
        $u->clean = $src->clean;
        $u->done = $src->done;
