...
// EvaEmailVerification SDK utility: graphql
//
...
class EvaEmailVerificationGraphql
{
    ...
    // equivalent.
    public static function body(EvaEmailVerificationContext $ctx): mixed
    {
    ...
    public static function errors(EvaEmailVerificationContext $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;
