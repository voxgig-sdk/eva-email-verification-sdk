...
// EvaEmailVerification SDK pipeline test
//
...
{
    private static function utility(): EvaEmailVerificationUtility
    {
        return new EvaEmailVerificationUtility();
    }
    ...
    private static function ctx(array $over = []): EvaEmailVerificationContext
    {
        $utility = $over['utility'] ?? self::utility();
        $client = $over['client'] ?? new PlClient(['base' => 'http://h']);
        $ctx = new EvaEmailVerificationContext([
            'client' => $client,
            'utility' => $utility,
        ], null);
        $ctx->op = new EvaEmailVerificationOperation(['name' => 'load', 'entity' => 'x']);
        foreach ($over as $k => $v) {
    ...
    {
        return ($err instanceof EvaEmailVerificationError) ? $err->sdk_code : '';
    }
    ...
    public function test_make_point_rejects_a_disallowed_operation(): void
    {
        ...
        $ctx->op = new EvaEmailVerificationOperation(['name' => 'nope', 'entity' => 'x']);
        [$point, $err] = EvaEmailVerificationMakePoint::call($ctx);
    ...
    public function test_make_point_rejects_an_operation_with_no_endpoints(): void
    {
        ...
        $ctx->op = new EvaEmailVerificationOperation(['name' => 'load', 'entity' => 'x', 'points' => []]);
        [$point, $err] = EvaEmailVerificationMakePoint::call($ctx);
        $this->assertNull($point);
    ...
    public function test_make_point_returns_the_single_point(): void
    {
        ...
        $ctx = self::ctx(['options' => ['allow' => ['op' => 'load,list,create,update,remove']]]);
        $ctx->op = new EvaEmailVerificationOperation(['name' => 'load', 'entity' => 'x', 'points' => [$point]]);
        [$got, $err] = EvaEmailVerificationMakePoint::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new EvaEmailVerificationSpec(['method' => 'GET']);
        $ctx = self::ctx();
        $ctx->out['spec'] = $preset;
        [$got, $err] = EvaEmailVerificationMakeSpec::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_response_guards_missing_spec_response_result(): void
    {
        $ctx = self::ctx([
            'spec' => null,
            'response' => new EvaEmailVerificationResponse([]),
            'result' => new EvaEmailVerificationResult([]),
        ]);
        [, $err] = EvaEmailVerificationMakeResponse::call($ctx);
        $this->assertSame('response_no_spec', self::code($err));

        $ctx = self::ctx([
            'spec' => new EvaEmailVerificationSpec([]),
            'response' => null,
            'result' => new EvaEmailVerificationResult([]),
        ]);
        [, $err] = EvaEmailVerificationMakeResponse::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'spec' => new EvaEmailVerificationSpec(['step' => 's']),
            'response' => new EvaEmailVerificationResponse(self::resp(404, null, ['x-a' => '1'])),
            'result' => new EvaEmailVerificationResult([]),
        ]);
        [, $err] = EvaEmailVerificationMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_2xx_parses_the_body_and_marks_ok(): void
    {
        $ctx = self::ctx([
            'spec' => new EvaEmailVerificationSpec(['step' => 's']),
            'response' => new EvaEmailVerificationResponse(self::resp(200, ['v' => 1])),
            'result' => new EvaEmailVerificationResult([]),
        ]);
        [, $err] = EvaEmailVerificationMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_records_to_ctrl_explain_when_explain_is_on(): void
    {
        $ctx = self::ctx([
            'spec' => new EvaEmailVerificationSpec(['step' => 's']),
            'response' => new EvaEmailVerificationResponse(self::resp(200, ['v' => 2])),
            'result' => new EvaEmailVerificationResult([]),
        ]);
        $ctx->ctrl->explain = ['on' => true];
        EvaEmailVerificationMakeResponse::call($ctx);
    ...
    {
        $preset = new EvaEmailVerificationResponse(self::resp(299));
        $ctx = self::ctx([
            'spec' => new EvaEmailVerificationSpec([]),
            'response' => new EvaEmailVerificationResponse([]),
            'result' => new EvaEmailVerificationResult([]),
        ...
        [$got, $err] = EvaEmailVerificationMakeResponse::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null, 'result' => new EvaEmailVerificationResult([])]);
        [, $err] = EvaEmailVerificationMakeResult::call($ctx);
        $this->assertSame('result_no_spec', self::code($err));

        $ctx = self::ctx(['spec' => new EvaEmailVerificationSpec([]), 'result' => null]);
        [, $err] = EvaEmailVerificationMakeResult::call($ctx);
    ...
    public function test_make_result_list_op_wraps_resdata_into_entity_instances(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new EvaEmailVerificationSpec(['step' => 's']),
            'result' => new EvaEmailVerificationResult(['ok' => true, 'resdata' => [['a' => 1], ['a' => 2]]]),
        ]);
        $ctx->op = new EvaEmailVerificationOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = EvaEmailVerificationMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_result_empty_list_yields_empty_resdata(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new EvaEmailVerificationSpec(['step' => 's']),
            'result' => new EvaEmailVerificationResult(['ok' => true, 'resdata' => []]),
        ]);
        $ctx->op = new EvaEmailVerificationOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = EvaEmailVerificationMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new EvaEmailVerificationResult(['ok' => true]);
        $ctx = self::ctx([
            'spec' => new EvaEmailVerificationSpec([]),
            'result' => new EvaEmailVerificationResult([]),
        ]);
        $ctx->out['result'] = $preset;
        [$got, $err] = EvaEmailVerificationMakeResult::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_request_guards_a_missing_spec(): void
    {
        ...
        [, $err] = EvaEmailVerificationMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $boom = new EvaEmailVerificationError('boom', 'boom');
        $utility->fetcher = function (EvaEmailVerificationContext $_c, string $_u, array $_f) use ($boom): array {
            return [null, $boom];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new EvaEmailVerificationSpec(['step' => 's', 'method' => 'GET', 'base' => 'http://h', 'parts' => ['a']]),
        ]);
        [$response, $err] = EvaEmailVerificationMakeRequest::call($ctx);
        $this->assertNull($err);
    ...
    {
        $utility = self::utility();
        $utility->fetcher = function (EvaEmailVerificationContext $_c, string $_u, array $_f): array {
            return [null, null];
        };
        $ctx = self::ctx([
            'utility' => $utility,
    ...
    public function test_make_request_a_normal_transport_response_is_wrapped(): void
    {
        ...
        [$response, $err] = EvaEmailVerificationMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertInstanceOf(EvaEmailVerificationResponse::class, $response);
    ...
    public function test_make_request_records_the_fetchdef_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->explain = ['on' => true];
        EvaEmailVerificationMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $utility->make_fetch_def = function (EvaEmailVerificationContext $c): array {
            return [null, $c->make_error('fetchdef_boom', 'boom')];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new EvaEmailVerificationSpec(['step' => 's', 'method' => 'GET']),
        ]);
        [$response, $err] = EvaEmailVerificationMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertNotNull($response->err);
    ...
    {
        $preset = new EvaEmailVerificationResponse(self::resp(201));
        $ctx = self::ctx(['spec' => new EvaEmailVerificationSpec([])]);
        $ctx->out['request'] = $preset;
        [$got, $err] = EvaEmailVerificationMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null]);
        [, $err] = EvaEmailVerificationMakeFetchDef::call($ctx);
    ...
    public function test_make_fetch_def_serialises_body_and_inits_missing_result(): void
    {
        ...
        [$fetchdef, $err] = EvaEmailVerificationMakeFetchDef::call($ctx);
        $this->assertNull($err);
    ...
    {
        $ctx = self::ctx(['result' => new EvaEmailVerificationResult(['ok' => true, 'resdata' => 42])]);
        $this->assertSame(42, EvaEmailVerificationDone::call($ctx));
    }

    public function test_done_raises_the_error_when_not_ok(): void
    {
        $ctx = self::ctx(['result' => new EvaEmailVerificationResult(['ok' => false])]);
        $this->expectException(EvaEmailVerificationError::class);
        EvaEmailVerificationDone::call($ctx);
    }

    public function test_make_error_returns_resdata_when_ctrl_throw_is_false(): void
    {
        $ctx = self::ctx(['result' => new EvaEmailVerificationResult(['ok' => false, 'resdata' => 'fallback'])]);
        $ctx->ctrl->throw_err = false;
        $this->assertSame('fallback', EvaEmailVerificationMakeError::call($ctx, null));
    }
    ...
    public function test_make_error_records_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->throw_err = false;
        $ctx->ctrl->explain = ['on' => true];
        EvaEmailVerificationMakeError::call($ctx, null);
    ...
    public function test_feature_add_appends_in_call_order(): void
    {
        ...
        $a = new EvaEmailVerificationBaseFeature();
        $b = new EvaEmailVerificationBaseFeature();
        EvaEmailVerificationFeatureAdd::call($ctx, $a);
        EvaEmailVerificationFeatureAdd::call($ctx, $b);
        $this->assertSame([$a, $b], $client->features);
    }

    private static function named_feature(string $name): EvaEmailVerificationBaseFeature
    {
        $f = new EvaEmailVerificationBaseFeature();
        $f->name = $name;
        return $f;
    }
    ...
    public function test_feature_add_ordering_before_after_replace(): void
    {
        ...
        EvaEmailVerificationFeatureAdd::call($ctx, self::named_feature('a'));
        EvaEmailVerificationFeatureAdd::call($ctx, self::named_feature('b'));
        $this->assertSame(['a', 'b'], $names());

        $before = self::named_feature('z1');
        $before->_options = ['__before__' => 'b'];
        EvaEmailVerificationFeatureAdd::call($ctx, $before);
        $this->assertSame(['a', 'z1', 'b'], $names());

        $after = self::named_feature('z2');
        $after->_options = ['__after__' => 'a'];
        EvaEmailVerificationFeatureAdd::call($ctx, $after);
        $this->assertSame(['a', 'z2', 'z1', 'b'], $names());

        $replace = self::named_feature('z3');
        $replace->_options = ['__replace__' => 'z1'];
        EvaEmailVerificationFeatureAdd::call($ctx, $replace);
        ...
        EvaEmailVerificationFeatureAdd::call($ctx, $miss);
    ...
    private static function auth_ctx(array $options, ?array $headers): EvaEmailVerificationContext
    {
        $client = new PlClient($options);
        return self::ctx([
            'client' => $client,
            'spec' => $headers === null ? null : new EvaEmailVerificationSpec(['headers' => $headers]),
        ]);
    }
    ...
    public function test_prepare_auth_guards_a_missing_spec(): void
    {
        ...
        [, $err] = EvaEmailVerificationPrepareAuth::call($ctx);
    ...
    public function test_prepare_auth_a_raw_apikey_goes_in_as_is(): void
    {
        ...
        EvaEmailVerificationPrepareAuth::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'response' => new EvaEmailVerificationResponse(['headers' => null]),
            'result' => new EvaEmailVerificationResult([]),
        ]);
        EvaEmailVerificationResultHeaders::call($ctx);
    ...
    public function test_result_body_skips_parsing_when_the_body_is_absent(): void
    {
        ...
        EvaEmailVerificationResultBody::call($ctx);
