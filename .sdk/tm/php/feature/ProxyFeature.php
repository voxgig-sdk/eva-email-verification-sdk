...
// EvaEmailVerification SDK proxy feature
...
class EvaEmailVerificationProxyFeature extends EvaEmailVerificationBaseFeature
{
    ...
    public function init(EvaEmailVerificationContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (EvaEmailVerificationContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
