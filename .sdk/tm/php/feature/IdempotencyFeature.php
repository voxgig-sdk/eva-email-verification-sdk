...
// EvaEmailVerification SDK idempotency feature
...
class EvaEmailVerificationIdempotencyFeature extends EvaEmailVerificationBaseFeature
{
    ...
    private function _mutating(EvaEmailVerificationContext $ctx): bool
    {
