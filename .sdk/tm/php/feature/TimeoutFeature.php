...
// EvaEmailVerification SDK timeout feature
...
class EvaEmailVerificationTimeoutFeature extends EvaEmailVerificationBaseFeature
{
    ...
    private function _with_timeout(EvaEmailVerificationContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(EvaEmailVerificationContext $_ctx, float $ms): void
    {
        $client = $this->client;
