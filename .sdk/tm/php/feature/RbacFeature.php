...
// EvaEmailVerification SDK rbac feature
...
class EvaEmailVerificationRbacFeature extends EvaEmailVerificationBaseFeature
{
    ...
    private function _required(EvaEmailVerificationContext $ctx): ?string
    {
    ...
    private function _reject(EvaEmailVerificationContext $ctx, string $required): void
    {
    ...
    private function _track(EvaEmailVerificationContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
