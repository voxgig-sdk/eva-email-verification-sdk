...
// EvaEmailVerification SDK cache feature
...
class EvaEmailVerificationCacheFeature extends EvaEmailVerificationBaseFeature
{
    ...
    private function _through(EvaEmailVerificationContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
