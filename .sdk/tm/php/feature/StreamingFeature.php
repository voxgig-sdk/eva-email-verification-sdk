...
// EvaEmailVerification SDK streaming feature
...
class EvaEmailVerificationStreamingFeature extends EvaEmailVerificationBaseFeature
{
    ...
    private function _iterate(EvaEmailVerificationResult $result): \Generator
    {
    ...
    private function _streamable(EvaEmailVerificationContext $ctx): bool
    {
