...
// EvaEmailVerification SDK clienttrack feature
...
class EvaEmailVerificationClienttrackFeature extends EvaEmailVerificationBaseFeature
{
    ...
    public function PostConstruct(EvaEmailVerificationContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'EvaEmailVerification-SDK';
