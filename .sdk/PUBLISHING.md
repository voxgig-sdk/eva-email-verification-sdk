...
|---|---|---|
| `ts/` | @voxgig-sdk/eva-email-verification-sdk | `.github/workflows/publish-ts.yml` |
...
required):
    ...
    npm trust github @voxgig-sdk/eva-email-verification-sdk \
      --repository voxgig-sdk/eva-email-verification-sdk \
      --file publish-ts.yml \
      --allow-publish

Then `npm trust list @voxgig-sdk/eva-email-verification-sdk` shows it, and
`npm trust revoke @voxgig-sdk/eva-email-verification-sdk --id=<id>` removes it.
